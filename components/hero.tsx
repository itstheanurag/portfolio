      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            ...
            className="inline-flex items-center px-4 py-2 rounded-md bg-neutral-100 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors text-sm font-medium"
          >
